...
//        }
    ...
    private fun initialMarkers(): ArrayList<PointF> {
        ...
        val points = arrayListOf<PointF>(
            // 1 - 5
            PointF(w * 0.0260417f, h * 0.0462963f),
            PointF(w * 0.0260417f, h * 0.2731481f),
            PointF(w * 0.0260417f, h * 0.5f),
            PointF(w * 0.0260417f, h * 0.7268519f),
            PointF(w * 0.0260417f, h * 0.9537037f),
            // 6 - 10
            PointF(w * 0.2630208f, h * 0.0462963f),
            PointF(w * 0.2630208f, h * 0.2731481f),
            PointF(w * 0.2630208f, h * 0.5f),
            PointF(w * 0.2630208f, h * 0.7268519f),
            PointF(w * 0.2630208f, h * 0.9537037f),
            // 11 - 15
            PointF(w * 0.5f, h * 0.0462963f),
            PointF(w * 0.5f, h * 0.2731481f),
            PointF(w * 0.5f, h * 0.5f),
            PointF(w * 0.5f, h * 0.7268519f),
            PointF(w * 0.5f, h * 0.9537037f),
            // 16 - 20
            PointF(w * 0.7369792f, h * 0.0462963f),
            PointF(w * 0.7369792f, h * 0.2731481f),
            PointF(w * 0.7369792f, h * 0.5f),
            PointF(w * 0.7369792f, h * 0.7268519f),
            PointF(w * 0.7369792f, h * 0.9537037f),
            // 21 - 25
            PointF(w * 0.9739583f, h * 0.0462963f),
            PointF(w * 0.9739583f, h * 0.2731481f),
            PointF(w * 0.9739583f, h * 0.5f),
            PointF(w * 0.9739583f, h * 0.7268519f),
